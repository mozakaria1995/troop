...
import 'package:troop/view/home/components/section_title.dart';
import 'package:troop/view/home/components/service_card.dart';
import 'package:troop/view/services/all_services_page.dart';
        ...
        children: [
          ...
          Consumer<AllServicesService>(
            builder: (context, allServiceProvider, child) =>
                SectionTitle(
                  cc: cc,
                  title: asProvider.getString('Recently listed'.tr()),
                  pressed: () {
